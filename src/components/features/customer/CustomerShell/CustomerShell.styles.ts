...
export const customerShellStyles = {
  ...
  navItem:
    'inline-flex shrink-0 items-center gap-2 rounded-full border border-border/70 bg-background px-3 py-2 text-sm text-foreground/80 transition-colors hover:border-border hover:text-foreground md:rounded-2xl md:px-3.5',
