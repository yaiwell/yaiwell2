...
export const verificationsQueueStyles = {
  ...
  typePill:
    'inline-flex items-center gap-1 rounded-full bg-stone-100 px-2 py-0.5 text-xs text-stone-700 ring-1 ring-inset ring-stone-200',
  submittedAt: 'text-sm text-muted-foreground',
  cta: 'inline-flex items-center justify-center gap-1.5 rounded-full bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90',
} as const;
