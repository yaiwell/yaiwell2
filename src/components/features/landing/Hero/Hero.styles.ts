...
export const heroStyles = {
  ...
  // Overlay cálido en degradado: stone oscuro arriba, mezcla a transparente
  // para mantener legibilidad del título sin matar la foto.
  overlay:
    'absolute inset-0 -z-10 bg-gradient-to-b from-stone-950/65 via-stone-900/40 to-stone-50/95',
  content:
  ...
  titleLine1:
    'text-balance text-4xl leading-tight font-semibold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl',
  titleLine2:
    'block bg-gradient-to-r from-amber-100 via-stone-100 to-amber-50 bg-clip-text font-serif italic text-transparent',
  subtitle:
    'max-w-2xl text-balance text-base leading-relaxed text-stone-100/95 sm:text-lg md:text-xl',
  searchCard:
  ...
  submit:
    'inline-flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-foreground px-6 text-sm font-semibold text-background transition-colors hover:bg-foreground/90 md:h-14 md:w-auto md:rounded-full md:px-8',
  ...
  badgeDot: 'h-1.5 w-1.5 rounded-full bg-emerald-300',
} as const;
