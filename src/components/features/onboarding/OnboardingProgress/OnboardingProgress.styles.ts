...
export const onboardingProgressStyles = {
  ...
  trackWrapper: 'relative flex w-full items-center justify-between',
  track: 'absolute left-0 right-0 top-1/2 h-px -translate-y-1/2 bg-border',
  trackFill:
    'absolute left-0 top-1/2 h-px -translate-y-1/2 bg-primary transition-all duration-300 ease-out',
