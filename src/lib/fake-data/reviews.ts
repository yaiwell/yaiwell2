...
export const fakeReviews: Review[] = [
  ...
  // ---------- prov-11 · Saló Bellesa Castellar (peluquería + estética, 8 reseñas) ----------
  {
    id: 'rev-85',
    providerId: 'prov-11',
    authorName: 'Roser P.',
    rating: 5,
    text: 'Vinc des de fa anys i sempre surto contenta. La Laia escolta el que vols i et proposa coses que t’afavoreixen sense pressió per vendre tractaments.',
    createdAt: daysAgo(6),
  },
  {
    id: 'rev-86',
    ...
    authorName: 'Marc V.',
    rating: 5,
    text: 'Me sorprendió la atención: cita puntual, café mientras esperaba y un corte de barba muy bien terminado. Precio justo para la calidad.',
    createdAt: daysAgo(14),
  },
  {
    id: 'rev-87',
    ...
    authorName: 'Anna B.',
    rating: 5,
    text: 'Tractament facial molt complet, amb explicació de cada pas. Vaig sortir amb la pell visiblement millor i sense la sensació de "venda" típica.',
    createdAt: daysAgo(28),
  },
  {
    id: 'rev-88',
    ...
    authorName: 'Elena T.',
    rating: 4,
    text: 'Servicio cercano y productos veganos como prometen. Solo una pega: el local se queda un poco justo cuando coinciden dos clientas con manicura.',
    createdAt: daysAgo(41),
  },
  {
    id: 'rev-89',
    ...
    authorName: 'Jordi C.',
    rating: 5,
    text: 'És un d’aquells centres familiars on et reben pel nom. Va molt bé per a una posta a punt ràpida sense haver de baixar a Sabadell.',
  ...
  },
  {
    ...
    authorName: 'Lola G.',
    rating: 5,
    text: 'Mi color quedó exactamente como lo pedí, sin tonos anaranjados raros. Se nota que controlan la decoloración y respetan el cabello.',
    createdAt: daysAgo(74),
  },
  {
    id: 'rev-91',
    ...
    authorName: 'Núria E.',
    rating: 4,
    text: 'Bon equip, ambient distès. La cita d’estètica em va anar molt bé tot i que vaig haver d’esperar 10 minuts extra; m’ho van compensar amb una mostra.',
  ...
  },
  {
    ...
    authorName: 'Sergi A.',
    rating: 5,
    text: 'Reservé online un sábado a primera hora y me atendieron sin esperas. Buen sitio para quien valora un trato cercano de pueblo grande.',
    createdAt: daysAgo(118),
  },

  // ---------- prov-12 · CrossFit Lliçà de Vall (box, 8 reseñas) ----------
  {
    id: 'rev-93',
    providerId: 'prov-12',
    authorName: 'Adrià M.',
    rating: 5,
    text: 'Coaches certificados Level 2 que de verdad te corrigen la técnica. He bajado tiempos en metcons y me he olvidado de las molestias lumbares antiguas.',
    createdAt: daysAgo(5),
  },
  {
    id: 'rev-94',
    ...
    authorName: 'Mar G.',
    rating: 5,
    text: 'Vaig entrar sense saber què era un WOD i m’han fet sentir part del grup des del primer dia. Box net, material en bon estat i bona música.',
    createdAt: daysAgo(11),
  },
  {
    id: 'rev-95',
    ...
    authorName: 'Òscar D.',
    rating: 5,
    text: 'Tengo dos coaches asignados según horario y noto que se hablan entre ellos para que progrese. Trato muy profesional, no es una pose.',
    createdAt: daysAgo(22),
  },
  {
    id: 'rev-96',
    ...
    authorName: 'Berta L.',
    rating: 5,
    text: 'Clase específica de mujeres una vez por semana — increíble idea. Salgo motivada y con la sensación de aprender algo nuevo cada sesión.',
    createdAt: daysAgo(35),
  },
  {
    id: 'rev-97',
    ...
    authorName: 'Pau S.',
    rating: 4,
    text: 'Bon nivell d’ensenyament i material correcte. L’única pega és que a la franja de 19h s’omple massa i de vegades has d’esperar per una barra.',
    createdAt: daysAgo(52),
  },
  {
    id: 'rev-98',
    ...
    authorName: 'Lucía F.',
    rating: 5,
    text: 'Probé con la clase de prueba gratuita y al final del WOD ya sabía que me apuntaba. La progresión escalada hace que no te sientas perdida.',
    createdAt: daysAgo(68),
  },
  {
    id: 'rev-99',
    ...
    authorName: 'Jaume R.',
    rating: 5,
    text: 'Vinc des de Granollers per la qualitat dels coaches. Hi ha bons WODs els dissabtes amb format equip que m’encanten.',
    createdAt: daysAgo(89),
  },
  {
    id: 'rev-100',
    ...
    authorName: 'Sara H.',
    rating: 4,
    text: 'Comunidad muy sana y horarios amplios incluso en festivos. Mejoraría algo la ventilación en verano, pero todo lo demás muy por encima de la media.',
    createdAt: daysAgo(115),
  },
];
